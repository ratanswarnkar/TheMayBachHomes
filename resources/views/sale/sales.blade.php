              ...
              <div class="text-center text-xl-start">
               ...
               <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/sale1-properties')}}"><img class="w-100" src="uploads/s1.jpg" alt=""></a>
					  <div class="list-price">INR 55 Lakh</div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/sale1-properties')}}">Retail shop for sale</a></h6>
                      <p class="list-text"> Spectrum @metro sector-75, Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/sale1-properties')}}"><span class="fa fa-object-ungroup"></span> 270 sq ft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        ...
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/sale1-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/sale2-properties')}}"><img class="w-100" src="uploads/s2.jpg" alt=""></a>
					   <div class="list-price">INR 1.20 Cr</div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/sale2-properties')}}">Luxury Villa for Sale</a></h6>
                      <p class="list-text">Sector 70, Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/sale2-properties')}}"><span class="fa fa-object-ungroup"></span>3008 sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Sale</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/sale2-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/sale3-properties')}}"><img class="w-100" src="uploads/s3.jpg" alt=""></a>
					   <div class="list-price">INR 30 Lakh </div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/sale3-properties')}}">Shop for Sale</a></h6>
                      <p class="list-text">KW Delhi6, Raj Nagar Extension, Ghaziabad</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/sale3-properties')}}"><span class="fa fa-object-ungroup"></span> 50 sqft.</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Sale</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/sale3-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/sale4-properties')}}"><img class="w-100" src="uploads/s4.jpg" alt=""></a>
					   <div class="list-price">INR 27 Lakh </div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/sale4-properties')}}">Shop</a></h6>
                      <p class="list-text">KW Delhi6, RajNagar Extension,Ghaziabad</p>
                      <div class="list-meta d-flex align-items-center">
                      ...
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        ...
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/sale4-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/sale5-properties')}}"><img class="w-100" src="uploads/s5.jpg" alt=""></a>
					   <div class="list-price">INR  1.15 Cr - 1.4 Cr </div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/sale5-properties')}}">Paradise Krishna Vatika Luxurious Villas</a></h6>
                      <p class="list-text">Sector 16B Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/sale5-properties')}}"><span class="fa fa-object-ungroup"></span>2100 - 2550 sq.ft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Sale</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/sale5-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/sale6-properties')}}"><img class="w-100" src="uploads/s6.jpg" alt=""></a>
					   <div class="list-price">INR  1.92 Cr - 3.07 Cr </div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/sale6-properties')}}">Elite X</a></h6>
                      <p class="list-text">Sector 10 Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        <!-- <a href="property.php?id=250&title=Al Yasmeen Villa"><span class="fa fa-bed"></span>5 bed</a>
                        <a href="property.php?id=250&title=Al Yasmeen Villa"><span class="fa fa-shower"></span>7 bath</a> -->
                        <a href="{{ asset('/sale6-properties')}}"><span class="fa fa-object-ungroup"></span>1800 - 2638 sq.ft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Sale</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/sale6-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
...
<section style="background-color: #000; color: #fff; padding: 20px 0;">
  <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <form id="enquiry-form" action="https://formspree.io/f/xjkanlqw" method="POST">
      ...
      <!-- Asking Price -->
      <div style="margin-bottom: 20px;">
        <label for="price" style="display: block; margin-bottom: 8px; color: #fff;">Asking Price</label>

...
<section class="property-detail-section">
  <div class="container">
    ...
    <div class="property-slider">
      <div class="slider-wrapper">
        <div class="slide active">
          <img src="{{ asset('uploads/o6a.avif') }}" alt="Lucky Wow Monk Image 1">
        </div>
        <div class="slide">
          <img src="{{ asset('uploads/o6b.avif') }}" alt="Lucky Wow Monk Image 2">
        </div>
        <div class="slide">
          <img src="{{ asset('uploads/o6c.avif') }}" alt="Lucky Wow Monk Image 3">
        </div>
        <div class="slide">
          <img src="{{ asset('uploads/o6d.avif') }}" alt="Lucky Wow Monk Image 4">
        </div>
        <div class="slide">
          <img src="{{ asset('uploads/o6e.avif') }}" alt="Lucky Wow Monk Image 5">
        </div>
    ...
    <div class="property-info">
      <h1>Lucky Wow Monk, Noida Extension, Khera Choganpur</h1>
      <p><strong>Location:</strong> Noida Extensions, Khera Choganpur</p>
      <p><strong>Price:</strong> ₹75.99 L – ₹95.99 L</p>
      <p><strong>Project Name:</strong> Lucky Wow Monk</p>
      <p><strong>Carpet Area:</strong> 1700 – 2200 sq.ft (Built-up Area)</p>
      <p><strong>Possession Starts:</strong> May 2026</p>
      <p><strong>Configuration:</strong> 3 & 4 BHK Apartments</p>
      <p><strong>RERA ID:</strong> Rera Not Applicable</p>

      <p class="description">
        <strong>Lucky Wow Monk</strong> by <strong>Lucky Homes Builder And Developers</strong> brings modern luxury living to Noida Extension.  
        This premium residential project offers spacious 3 & 4 BHK apartments designed for comfort, convenience, and elegance.  
        Strategically located near top schools, malls, and hospitals, Lucky Wow Monk ensures a perfect balance of urban connectivity and serene lifestyle.
      </p>

      <h2>📊 Overview</h2>
      <ul>
        <li><strong>Project Area:</strong> — </li>
        <li><strong>Project Size:</strong> 6 Buildings – 90 Units</li>
        <li><strong>Sizes:</strong> 1700 – 2200 sq.ft</li>
        <li><strong>Average Price:</strong> ₹4.42 K / sq.ft</li>
        <li><strong>Possession Starts:</strong> May 2026</li>
        <li><strong>Launch Date:</strong> Aug 2025</li>
        <li><strong>Configuration:</strong> 3 & 4 BHK Apartments</li>
      </ul>

      <h2>🏢 Additional Details</h2>
      <ul>
        <li><strong>RERA ID:</strong> Rera Not Applicable</li>
        <li><strong>Developer:</strong> Lucky Homes Builder And Developers</li>
        <li><strong>Property Type:</strong> Residential Apartments</li>
        <li><strong>Location Advantage:</strong> 5 mins from Gaur City Mall & Galaxy Blue Sapphire, 15 mins from DLF Mall of India</li>
        <li><strong>Nearby School:</strong> Delhi World Public School, Noida Extension</li>
        <li><strong>Nearby Mall:</strong> Ace City Square</li>
        <li><strong>Nearby Hospital:</strong> Yatharth Super Speciality Hospital, Noida Extension</li>
        <li><strong>Nearby Restaurant:</strong> Lazeez Biryani Wala</li>

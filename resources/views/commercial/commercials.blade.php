          ...
          <div class="col-xl-12">
            <div class="mt30">
              <div class="text-center text-xl-start">
                <br>
                <h4 class="mb-1" style="padding-bottom:20px; color:#fff;">Commercials Properties</h4>                
              </div>
               ...
               <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/commercial1-properties')}}"><img class="w-100" src="uploads/c1.jpg" alt=""></a>
					   <div class="list-price">INR 38.0 L </div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/commercial1-properties')}}">Ready to use Office Space</a></h6>
                      <p class="list-text">Techzone IV Greater Noida West, Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/commercial1-properties')}}"><span class="fa fa-object-ungroup"></span>350 Sqft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        ...
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/commercial1-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/commercial2-properties')}}"><img class="w-100" src="uploads/c2.jpg" alt=""></a>
					   <div class="list-price">INR 1.25 Cr </div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/commercial2-properties')}}">275 sq.ft Shop, Noida Extension, Greater Noida/a></h6>
                      <p class="list-text">Techzone IV Greater Noida West, Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/commercial2-properties')}}"><span class="fa fa-object-ungroup"></span>275 sq.ft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Sale</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/commercial2-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/commercial3-properties')}}"><img class="w-100" src="uploads/c3.jpg" alt=""></a>
					   <div class="list-price">INR  52.0 L </div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/commercial3-properties')}}">678 sq.ft Bare shell Office Space, Noida Extension, Greater Noida</a></h6>
                      <p class="list-text">Techzone IV Greater Noida West, Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/commercial3-properties')}}"><span class="fa fa-object-ungroup"></span>678 sq.ft  sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Sale</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/commercial3-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/commercial4-properties')}}"><img class="w-100" src="uploads/c4.jpg" alt=""></a>
					   <div class="list-price">INR 1.2 Cr </div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/commercial4-properties')}}">380 sq.ft Shop, Noida Extension, Greater Noida</a></h6>
                      <p class="list-text">Sector 3 Greater Noida West, Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/commercial4-properties')}}"><span class="fa fa-object-ungroup"></span>380  sq.ft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Sale</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/commercial4-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/commercial5-properties')}}"><img class="w-100" src="uploads/c5.jpg" alt=""></a>
					   <div class="list-price">INR  92.0 L </div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/commercial5-properties')}}">167 sq.ft Shop, Noida Extension, Greater Noida</a></h6>
                      <p class="list-text">Sector 4 Greater Noida West, Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/commercial5-properties')}}"><span class="fa fa-object-ungroup"></span>167  sq.ft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Sale</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/commercial5-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/commercial6-properties')}}"><img class="w-100" src="uploads/c6.jpg" alt=""></a>
					   <div class="list-price">INR  1.63 Cr </div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/commercial6-properties')}}">300 sq.ft Shop, Noida Extension, Greater Noida</a></h6>
                      <p class="list-text">Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        <!-- <a href="property.php?id=250&title=Al Yasmeen Villa"><span class="fa fa-bed"></span>5 bed</a>
                        <a href="property.php?id=250&title=Al Yasmeen Villa"><span class="fa fa-shower"></span>7 bath</a> -->
                        <a href="{{ asset('/commercial6-properties')}}"><span class="fa fa-object-ungroup"></span>300  sq.ft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Sale</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/commercial6-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>

...
<section class="property-detail-section">
  <div class="container">
    ...
    <div class="property-slider">
      <div class="slider-wrapper">
        <div class="slide active">
          <img src="{{ asset('uploads/villa3a.jpg') }}" alt="5 BHK For Sale in Sector 33, Noida Image 1">
        </div>
        <div class="slide">
          <img src="{{ asset('uploads/villa3b.jpg') }}" alt="5 BHK For Sale in Sector 33, Noida Image 2">
        </div>
        <div class="slide">
          <img src="{{ asset('uploads/villa3c.jpg') }}" alt="5 BHK For Sale in Sector 33, Noida Image 3">
        </div>
        <div class="slide">
          <img src="{{ asset('uploads/villa3d.jpg') }}" alt="5 BHK For Sale in Sector 33, Noida Image 4">
        </div>
        <div class="slide">
          <img src="{{ asset('uploads/villa3e.jpg') }}" alt="5 BHK For Sale in Sector 33, Noida Image 5">
        </div>
    ...
    <div class="property-info">
      <h1>5 BHK For Sale in Sector 33, Noida</h1>
      <p><strong>Location:</strong> Sector 33, Noida - Central Noida, Delhi NCR</p>
      <p><strong>Price:</strong> ₹6.80 Cr | <strong>EMI:</strong> ₹2.36L | <a href="#">Need Home Loan? Check Eligibility</a></p>
      <p><strong>Carpet Area:</strong> 3,200 sqft (₹21,281/sqft)</p>
      <p><strong>Configuration:</strong> 5 Beds | 5 Baths | 2 Balconies</p>
      <p><strong>Furnishing:</strong> Furnished</p>
      <p><strong>Ownership Type:</strong> Leasehold</p>
      <p><strong>Status:</strong> Ready to Move</p>

      <p class="description">
        Experience premium independent living with this elegant <strong>5 BHK villa in Sector 33, Noida</strong>.  
        The property features spacious interiors, modern wooden flooring, and excellent natural lighting.  
        Located near <strong>Noida Sector 34 Metro Station</strong>, it offers convenient access to major hubs and a peaceful residential neighborhood.  
        Ideal for those seeking a balance of comfort, luxury, and convenience.
      </p>

      <h2>📊 Overview</h2>
      <ul>
        <li><strong>Transaction Type:</strong> Resale</li>
        <li><strong>Car Parking:</strong> 2 Covered, 2 Open</li>
        <li><strong>Facing:</strong> North-East</li>
        <li><strong>Flooring:</strong> Wooden</li>
      ...
      <ul>
        <li><strong>Additional Rooms:</strong> Puja Room, Study</li>
        <li><strong>Overlooking:</strong> Garden/Park</li>
        <li><strong>Booking Amount:</strong> ₹10.0 Lac</li>
        <li><strong>Registration Charges:</strong> ₹34,04,950 Approx.</li>
        <li><strong>Monthly Maintenance:</strong> ₹500</li>
        <li><strong>Offer:</strong> Save up to 40% on Dream Home Interiors</li>
        <li><strong>Landmarks:</strong> Noida Sector 34 Metro Station</li>
      </ul>

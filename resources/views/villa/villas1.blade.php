...
<section class="property-detail-section">
  <div class="container">
    ...
    <div class="property-info">
      ...
      <p><strong>Price:</strong> ₹9.48 Cr | <strong>EMI:</strong> ₹3.28L | <a href="#">Need Home Loan? Check Eligibility</a></p>
      <p><strong>Super Built-up Area:</strong> 5,350 sqft</p>
      <p><strong>Configuration:</strong> 5 Beds | 4 Baths | 5 Balconies</p>
      <p><strong>Furnishing:</strong> Unfurnished</p>
      <p><strong>Ownership Type:</strong> Freehold</p>
      <p><strong>Status:</strong> Ready to Move</p>

      <p class="description">
        Discover the epitome of luxury with this magnificent <strong>5 BHK villa</strong> in <strong>Jaypee Greens Kingswood Oriental, Sector 128, Noida</strong>.  
        Featuring elegant architecture, premium interiors, and a serene environment, this ready-to-move property offers a sophisticated lifestyle for elite homeowners.  
        Located in one of Noida’s most premium sectors, this villa ensures seamless connectivity, world-class amenities, and lush green surroundings.
      </p>

...
<section class="property-detail-section">
  <div class="container">
    ...
    <div class="property-slider">
      <div class="slider-wrapper">
        <div class="slide active">
          <img src="{{ asset('uploads/super5a.jpg') }}" alt="Country Farm Image 1">
        </div>
        <div class="slide">
          <img src="{{ asset('uploads/super5b.jpg') }}" alt="Country Farm Image 2">
        </div>
        <div class="slide">
          <img src="{{ asset('uploads/super5c.jpg') }}" alt="Country Farm Image 3">
        </div>
        <div class="slide">
          <img src="{{ asset('uploads/super5d.jpeg') }}" alt="Country Farm Image 4">
        </div>
        <div class="slide">
          <img src="{{ asset('uploads/super5e.jpeg') }}" alt="Country Farm Image 5">
        </div>
    ...
    <div class="property-info">
      <h1>2 BHK For Sale in Country Farm, Sector 150, Noida</h1>
      <p><strong>Location:</strong> Sector 150, Noida - Rest of Noida, Delhi NCR</p>
      <p><strong>Price:</strong> ₹95.0 Lac | <strong>EMI:</strong> ₹33k | <a href="#">Need Home Loan? Check Eligibility</a></p>
      <p><strong>Project Name:</strong> Country Farm</p>
      <p><strong>Carpet Area:</strong> 2,700 sq.ft</p>
      <p><strong>Configuration:</strong> 2 Beds | 2 Baths | 1 Store Room</p>
      <p><strong>Furnishing:</strong> Furnished</p>
      <p><strong>Ownership Type:</strong> Freehold</p>
      <p><strong>Status:</strong> Ready to Move</p>

      <p class="description">
        Experience peaceful living at <strong>Country Farm</strong>, Sector 150, Noida.  
        This 2 BHK farmhouse offers a prime location with excellent connectivity, surrounded by lush green surroundings and modern infrastructure.  
        Ideal for a healthy and positive lifestyle, it’s perfect for families looking for comfort and convenience in one of Noida’s most sought-after sectors.
      </p>

      <h2>📊 Overview</h2>
      <ul>
        <li><strong>Transaction Type:</strong> New Property</li>
        <li><strong>Carpet Area:</strong> 2,700 sq.ft</li>
        <li><strong>Price per sq.ft:</strong> ₹3,519</li>
      ...
      <ul>
        <li><strong>Booking Amount:</strong> ₹51,000</li>
        <li><strong>Overlooking:</strong> Main Road</li>
        <li><strong>Floors Allowed for Construction:</strong> 1</li>
        <li><strong>Flooring:</strong> Vitrified</li>
        <li><strong>Additional Rooms:</strong> Puja Room, Study, Store, Servant Room</li>
        <li><strong>Nearby Landmark:</strong> TATA Residential Society and ATS</li>
      </ul>

      <h2>⚙️ Facilities</h2>
      <ul>
        <li>Modern Infrastructure</li>
        <li>Spacious and Well-Ventilated Design</li>
      ...
      <p class="description">
        ...
        THIS IS A GOOD LOCATION AND BEST FOR HEALTH AND GOOD POSITIVITY.  
        Prime location with excellent connectivity. Spacious and well-ventilated farmhouse with modern amenities and infrastructure.  
        Suitable for various types of residential or business use.
      </p>
    </div>

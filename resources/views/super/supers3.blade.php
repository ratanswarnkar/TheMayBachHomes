...
<section class="property-detail-section">
  <div class="container">
    ...
    <div class="property-slider">
      <div class="slider-wrapper">
        <div class="slide active">
          <img src="{{ asset('uploads/super4e.jfif') }}" alt="Dkrrish Green Beauty Farms Image 1">
        </div>
        <div class="slide">
          <img src="{{ asset('uploads/super4a.jpeg') }}" alt="Dkrrish Green Beauty Farms Image 2">
        </div>
        <div class="slide">
          <img src="{{ asset('uploads/super4b.jpeg') }}" alt="Dkrrish Green Beauty Farms Image 3">
        </div>
        <div class="slide">
          <img src="{{ asset('uploads/super4c.jfif') }}" alt="Dkrrish Green Beauty Farms Image 4">
        </div>
        <div class="slide">
          <img src="{{ asset('uploads/super4d.jpg') }}" alt="Dkrrish Green Beauty Farms Image 5">
        </div>
    ...
    <div class="property-info">
      <h1>2 BHK For Sale in Dkrrish Green Beauty Farms, Sector 135, Noida</h1>
      <p><strong>Location:</strong> Behind JP Wishtown, Sector 135, Noida - Noida Expressway, Delhi NCR</p>
      ...
      <p><strong>Carpet Area:</strong> 100 sq. yards</p>
      ...
      <p class="description">
        Experience comfort and nature together with this stunning <strong>2 BHK flat at Dkrrish Green Beauty Farms</strong>, Sector 135, Noida.  
        This semi-furnished resale unit offers spacious interiors, a modern layout, and proximity to key landmarks such as <strong>Sector 137 Metro Station</strong>, <strong>Jaypee School</strong>, and <strong>Max Hospital</strong>.  
        With top-quality finishes and a peaceful environment, it’s the perfect home for families seeking modern living in a prime location.
      </p>

      <h2>📊 Overview</h2>
      <ul>
        <li><strong>Transaction Type:</strong> Resale</li>
        <li><strong>Carpet Area:</strong> 100 sq. yards</li>
        <li><strong>Price per sq. unit:</strong> ₹1,25,000 / sq. yard</li>
        <li><strong>Facing:</strong> North-East</li>
        <li><strong>Furnished Status:</strong> Semi-Furnished</li>
      ...
      <ul>
        <li><strong>Booking Amount:</strong> ₹12.5 Lac</li>
        <li><strong>Overlooking:</strong> Main Road</li>
        <li><strong>Floors Allowed for Construction:</strong> 2</li>
        <li><strong>Flooring:</strong> Vitrified, Wooden, Ceramic Tiles, Marble, Granite</li>
        ...
        <li><strong>Nearby Landmarks:</strong> Sector 137 Metro, Jaypee School, Max Hospital</li>
      </ul>

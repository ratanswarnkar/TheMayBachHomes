          ...
          <div class="col-xl-12">
            <div class="mt30">
              <div class="text-center text-xl-start">
                <br>
                <h4 class="mb-1" style="padding-bottom:20px; color:#fff;">Apartments</h4>                
              </div>
               ...
               <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/apartments1-properties')}}"><img class="w-100" src="uploads/a1.jpg" alt=""></a>
					   <div class="list-price">INR  29.5 L - 53.51 L </div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/apartments1-properties')}}">Signix Harmony Heights</a></h6>
                      <p class="list-text">Noida Extension, Khera Choganpur</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/apartments1-properties')}}"><span class="fa fa-object-ungroup"></span>650 - 1500 Sqft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        ...
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/apartments1-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/apartments2-properties')}}"><img class="w-100" src="uploads/a2.jpg" alt=""></a>
					   <div class="list-price">INR 47.99 L - 64.99 L </div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/apartments2-properties')}}">Vihaan Wardania</a></h6>
                      <p class="list-text">Sector 1 Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/apartments2-properties')}}"><span class="fa fa-object-ungroup"></span>1100 - 1650  sq.ft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Sale</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/apartments2-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/apartments3-properties')}}"><img class="w-100" src="uploads/a3.jpg" alt=""></a>
					   <div class="list-price">INR  1.42 Cr - 2.38 Cr </div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/apartments3-properties')}}">Renox Thrive</a></h6>
                      ...
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/apartments3-properties')}}"><span class="fa fa-object-ungroup"></span>1582 - 2644 sq.ft  sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Sale</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/apartments3-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/apartments4-properties')}}"><img class="w-100" src="uploads/a4.jpg" alt=""></a>
					   <div class="list-price">INR 1.83 Cr - 2.54 Cr </div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/apartments4-properties')}}">The Valley</a></h6>
                      <p class="list-text">Plot No. GH-15, Sector 1 Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/apartments4-properties')}}"><span class="fa fa-object-ungroup"></span>1830 - 2540 sq.ft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Sale</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/apartments4-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/apartments5-properties')}}"><img class="w-100" src="uploads/a5.jpg" alt=""></a>
					   <div class="list-price">INR  54.52 L - 1.07 Cr </div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/apartments5-properties')}}">Pearl Vista</a></h6>
                      <p class="list-text">Noida Extension, Khera Choganpur</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/apartments5-properties')}}"><span class="fa fa-object-ungroup"></span>1020 - 2000 sq.ft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Sale</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/apartments5-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/apartments6-properties')}}"><img class="w-100" src="uploads/a6.jpg" alt=""></a>
					   <div class="list-price">INR  84.0 L - 96.8 L </div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/apartments6-properties')}}">Saviour Vridhi Towers</a></h6>
                      <p class="list-text">GH-05 C, Sector 16, Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        <!-- <a href="property.php?id=250&title=Al Yasmeen Villa"><span class="fa fa-bed"></span>5 bed</a>
                        <a href="property.php?id=250&title=Al Yasmeen Villa"><span class="fa fa-shower"></span>7 bath</a> -->
                        <a href="{{ asset('/apartments6-properties')}}"><span class="fa fa-object-ungroup"></span>1050 - 1210  sq.ft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Sale</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/apartments6-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>

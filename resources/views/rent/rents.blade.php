               ...
               <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    ...
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/rent1-properties')}}">2.5 BHK Flat for Rent</a></h6>
                      <p class="list-text">Elegant Splendour, Techzone IV Greater Noida West, Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/rent1-properties')}}"><span class="fa fa-object-ungroup"></span>1190 Sqft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        ...
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/rent1-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    ...
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/rent2-properties')}}">3 BHK Flat for Rent</a></h6>
                      <p class="list-text">Nirala Estate II, Techzone IV Greater Noida West, Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/rent2-properties')}}"><span class="fa fa-object-ungroup"></span>1247 sq.ft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Rent</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/rent2-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    ...
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/rent3-properties')}}">3 BHK Flat for Rent</a></h6>
                      <p class="list-text">Aastha Greens, Sector 4 Greater Noida West, Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/rent3-properties')}}"><span class="fa fa-object-ungroup"></span>1390 sq.ft  sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Rent</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/rent3-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    ...
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/rent4-properties')}}">3 BHK Flat for Rent</a></h6>
                      <p class="list-text">ATS Happy Trails, Vaidpura, Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/rent4-properties')}}"><span class="fa fa-object-ungroup"></span>1625  sq.ft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Rent</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/rent4-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-4">
                  <div class="listing-style1 salessection">
                    <div class="list-thumb">
                      <a href="{{ asset('/rent5-properties')}}"><img class="w-100" src="uploads/r4c.avif" alt=""></a>
					   <div class="list-price">INR  28,000 per month</div>
	                   
                    </div>
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/rent5-properties')}}">3 BHK Flat for Rent</a></h6>
                      <p class="list-text">ATS Happy Trails, Vaidpura, Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        ...
                        <a href="{{ asset('/rent5-properties')}}"><span class="fa fa-object-ungroup"></span>1385  sq.ft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Rent</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/rent5-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="listing-style1 salessection">
                    ...
                    <div class="list-content">
                      <h6 class="list-title"><a href="{{ asset('/rent6-properties')}}">3 BHK Flat for Rent</a></h6>
                      <p class="list-text">ATS Nobility, Sector 4 Greater Noida West, Noida Extension, Greater Noida</p>
                      <div class="list-meta d-flex align-items-center">
                        <!-- <a href="property.php?id=250&title=Al Yasmeen Villa"><span class="fa fa-bed"></span>5 bed</a>
                        <a href="property.php?id=250&title=Al Yasmeen Villa"><span class="fa fa-shower"></span>7 bath</a> -->
                        <a href="{{ asset('/rent6-properties')}}"><span class="fa fa-object-ungroup"></span>1675  sq.ft sqft</a>
                      </div>
                      <hr class="mt-2 mb-2">
                      <div class="list-meta2 d-flex justify-content-between align-items-center">
                        <span class="for-what">For Rent</span>
                        <div class="icons d-flex align-items-center">
                         ...
                         <span class="project-type"><a href="{{ asset('/rent6-properties')}}"> View Details <i class="fa fa-long-arrow-right"></i></a></span>
                        </div>
                      </div>
                    </div>
                  </div>

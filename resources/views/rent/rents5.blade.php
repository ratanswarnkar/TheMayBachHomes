...
<section class="property-detail-section">
  <div class="container">
    ...
    <div class="property-info">
      ...
      <p><strong>Rent:</strong> ₹28,000 / month</p>
      <p><strong>Security Deposit:</strong> ₹28,000</p>
      <p><strong>Brokerage:</strong> ₹14,000</p>
      <p><strong>Built-up Area:</strong> 1385 sq.ft (≈ 128.67 m²)</p>
      <p><strong>Carpet Area:</strong> 930 sq.ft (≈ 86.40 m²)</p>
      <p><strong>Furnishing:</strong> Semi Furnished</p>
      <p><strong>Bathrooms:</strong> 2 | <strong>Balconies:</strong> 3</p>
      <p><strong>Floor:</strong> 15 of 28 Floors</p>
      ...
      <p><strong>Parking:</strong> 1 Covered Parking</p>
      <p><strong>Main Entrance Facing:</strong> West</p>
      <p><strong>Gas Pipeline:</strong> Yes</p>

      <p class="description">
        A beautiful semi-furnished 3 BHK flat in ATS Happy Trails, Sector 10 Greater Noida West. 
        The flat offers comfort and convenience with a modular kitchen, spacious balconies, and well-lit interiors.
        Located in a gated society with modern amenities including a gym, swimming pool, and 24x7 security, 
        this property is perfect for families seeking a peaceful lifestyle.
      </p>

      <h2>🏠 Overview</h2>
      <ul>
        <li><strong>Project Name:</strong> ATS Happy Trails</li>
        <li><strong>Rent:</strong> ₹28,000 / month</li>
        <li><strong>Security Deposit:</strong> ₹28,000</li>
        <li><strong>Brokerage:</strong> ₹14,000</li>
        <li><strong>Built-up Area:</strong> 1385 sq.ft</li>
        <li><strong>Carpet Area:</strong> 930 sq.ft</li>
        <li><strong>Furnishing:</strong> Semi Furnished</li>
        <li><strong>Bathrooms:</strong> 2</li>
        <li><strong>Balconies:</strong> 3</li>
        <li><strong>Floor:</strong> 15 / 28</li>
      ...
      <h2>📍 Nearby</h2>
      <ul>
        <li><strong>Delhi World Public School:</strong> Nearby</li>
